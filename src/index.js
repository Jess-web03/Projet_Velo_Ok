  ...
  const feedback = () => {
    if (counterQuestions === 6) {
      $('#bikeImg')
        .empty()
        .after(
          '<p class="choisis">Choisis ton badge</p><div class="rowB"><img src="../assets/images/Queen.svg" alt="queen" class="badgeImg colB"><img src="../assets/images/King.svg" class="badgeImg colB" alt="king"></div>',
        );
